...
CREATE INDEX specialties_description ON specialties (description);
...
ALTER TABLE pets
    ADD CONSTRAINT fk_pets_types FOREIGN KEY (pet_type_id) REFERENCES pet_types (id);
